    ...
    public void setupSelectedLanguages(String language) {
        switch (language) {
            case "Russian":
                ...
                break;
            case "Macedonian":
                buttonCancel.setText(bundleMk.getString("cancel"));
                buttonOK.setText(bundleMk.getString("confirm"));
                message1 = bundleMk.getString("insMessage1");
                message2 = bundleMk.getString("insMessage2");
                message3 = bundleMk.getString("insMessage3");
                message4 = bundleMk.getString("insMessage4");
                message7 = bundleMk.getString("insMessage7");
                message8 = bundleMk.getString("insMessage8");
                message9 = bundleMk.getString("insMessage9");
                message10 = bundleMk.getString("numbMessage1");
                message11 = bundleMk.getString("numbMessage2");
                break;
            case "Danish":
                buttonCancel.setText(bundleDa.getString("cancel"));
                buttonOK.setText(bundleDa.getString("confirm"));
                message1 = bundleDa.getString("insMessage1");
                message2 = bundleDa.getString("insMessage2");
                message3 = bundleDa.getString("insMessage3");
                message4 = bundleDa.getString("insMessage4");
                message7 = bundleDa.getString("insMessage7");
                message8 = bundleDa.getString("insMessage8");
                message9 = bundleDa.getString("insMessage9");
                message10 = bundleDa.getString("numbMessage1");
                message11 = bundleDa.getString("numbMessage2");
                break;

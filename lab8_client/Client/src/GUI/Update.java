    ...
    public void setupSelectedLanguages(String language) {
        switch (language) {
            case "Russian":
                ...
                break;
            case "Macedonian":
                buttonOK.setText(bundleMk.getString("execute"));
                buttonCancel.setText(bundleMk.getString("cancel"));
                text1Label.setText(bundleMk.getString("newValue"));
                ...
                break;
            case "Danish":
                buttonOK.setText(bundleDa.getString("execute"));
                buttonCancel.setText(bundleDa.getString("cancel"));
                text1Label.setText(bundleDa.getString("newValue"));

...
public class DataCheckerForClient implements Serializable {
    ...
    public boolean checkWorker(Command command) {
        ...
        System.out.println(checkName(command.getName()));
        System.out.println(checkX(command.getX()));
        System.out.println(checkY(command.getY()));
        System.out.println(checkBirthday(command.getBirthday()));
        System.out.println(checkStatus(command.getStatus()));
        System.out.println(checkPosition(command.getPosition()));
